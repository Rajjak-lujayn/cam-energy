...
if ( ! class_exists( 'WPCleverWooco' ) && class_exists( 'WC_Product' ) ) {
	class WPCleverWooco {
                ...
                <td>
                    <div class="wooco_component_inner <?php echo esc_attr( $active ? 'active' : '' ); ?>">
                        <div class="wooco_component_heading">
                            ...
                            <span class="wooco_component_name"><?php echo strip_tags( $component['name'] ); ?></span>
                            <a class="wooco_duplicate_component" href="#"><?php esc_html_e( 'duplicate', 'wpc-composite-products' ); ?></a>
                            <a class="wooco_remove_component" href="#"><?php esc_html_e( 'remove', 'wpc-composite-products' ); ?></a>
                        </div>
                        <div class="wooco_component_content">
                            <div class="wooco_component_content_line">
                                ...
                                <div class="wooco_component_content_line_value">
                                    <input name="wooco_components[<?php echo esc_attr( $key ); ?>][name]" type="text" class="wooco_component_name_val" value="<?php echo $component['name']; ?>" placeholder="<?php esc_attr_e( 'Name', 'wpc-composite-products' ); ?>"/>
                                </div>
                            </div>
                            <div class="wooco_component_content_line">
                                <div class="wooco_component_content_line_label">
                                ...
                                <div class="wooco_component_content_line_value">
                                    <textarea class="wooco_component_desc_val" name="wooco_components[<?php echo esc_attr( $key ); ?>][desc]" placeholder="<?php esc_attr_e( 'Description', 'wpc-composite-products' ); ?>"><?php echo $component['desc']; ?></textarea>
                                </div>
                            </div>
                            <div class="wooco_component_content_line">
                                <div class="wooco_component_content_line_label">
                                ...
                                <div class="wooco_component_content_line_value">
                                    <select name="wooco_components[<?php echo esc_attr( $key ); ?>][type]" class="wooco_component_type wooco_component_type_val">
                                    ...
                                    <span><?php esc_html_e( 'Order by', 'wpc-composite-products' ); ?> <select name="wooco_components[<?php echo esc_attr( $key ); ?>][orderby]" class="wooco_component_orderby_val">
                                    ...
                                    <span><?php esc_html_e( 'Order', 'wpc-composite-products' ); ?> <select name="wooco_components[<?php echo esc_attr( $key ); ?>][order]" class="wooco_component_order_val">
                            ...
                            <div class="wooco_component_content_line wooco_hide wooco_show_if_other">
                                ...
                                <div class="wooco_component_content_line_value">
									...
									?>
                                    <select class="wooco_terms wooco_component_other_val" multiple="multiple" name="wooco_components[<?php echo esc_attr( $key ); ?>][other][]" data-<?php echo esc_attr( $component['type'] ); ?>="<?php echo esc_attr( implode( ',', $other ) ); ?>">
										<?php
										if ( ! empty( $other ) ) {
											foreach ( $other as $t ) {
                            ...
                            <div class="wooco_component_content_line wooco_hide wooco_show_if_products">
                                ...
                                <div class="wooco_component_content_line_value">
                                    <select class="wooco_products wooco_component_products_val" data-allow_clear="false" style="width: 100%;" data-sortable="1" multiple="multiple" name="wooco_components[<?php echo esc_attr( $key ); ?>][products][]" data-placeholder="<?php esc_attr_e( 'Search for a product&hellip;', 'wpc-composite-products' ); ?>">
										<?php
                            ...
                            <div class="wooco_component_content_line wooco_show wooco_hide_if_products">
                                ...
                                <div class="wooco_component_content_line_value">
                                    <select class="wooco_products wooco_component_exclude_val" data-allow_clear="false" style="width: 100%;" data-sortable="1" multiple="multiple" name="wooco_components[<?php echo esc_attr( $key ); ?>][exclude][]" data-placeholder="<?php esc_attr_e( 'Search for a product&hellip;', 'wpc-composite-products' ); ?>">
										<?php
                            ...
                            <div class="wooco_component_content_line">
                                ...
                                <div class="wooco_component_content_line_value">
                                    <select class="wooco_products" style="width: 100%;" data-allow_clear="true" name="wooco_components[<?php echo esc_attr( $key ); ?>][default]" data-placeholder="<?php esc_attr_e( 'Search for a product&hellip;', 'wpc-composite-products' ); ?>">
										<?php
                            ...
                            <div class="wooco_component_content_line">
                                ...
                                <div class="wooco_component_content_line_value">
                                    <select name="wooco_components[<?php echo esc_attr( $key ); ?>][optional]" class="wooco_component_optional_val">
                            ...
                            <div class="wooco_component_content_line">
                                ...
                                <div class="wooco_component_content_line_value">
                                    <input name="wooco_components[<?php echo esc_attr( $key ); ?>][price]" class="wooco_component_price_val" type="text" style="width: 60px; display: inline-block" value="<?php echo self::format_price( $component['price'] ); ?>"/>
                                    <span class="woocommerce-help-tip" data-tip="<?php esc_html_e( 'Set a new price using a number (eg. "49" for $49) or a percentage (eg. "90%" of the original price).', 'wpc-composite-products' ); ?>"></span>
                                </div>
                            </div>
                            <div class="wooco_component_content_line">
                                <div class="wooco_component_content_line_label">
                                ...
                                <div class="wooco_component_content_line_value">
                                    <input name="wooco_components[<?php echo esc_attr( $key ); ?>][qty]" class="wooco_component_qty_val" type="number" min="0" step="<?php echo esc_attr( $step ); ?>" value="<?php echo esc_attr( $component['qty'] ); ?>"/>
                                </div>
                            </div>
                            <div class="wooco_component_content_line">
                                <div class="wooco_component_content_line_label">
                                ...
                                <div class="wooco_component_content_line_value">
                                    <select name="wooco_components[<?php echo esc_attr( $key ); ?>][custom_qty]" class="wooco_component_custom_qty_val">
                            ...
                            <div class="wooco_component_content_line wooco_show_if_custom_qty">
                                ...
                                <div class="wooco_component_content_line_value">
                                    ...
                                    <input name="wooco_components[<?php echo esc_attr( $key ); ?>][min]" class="wooco_component_min_val" type="number" min="0" step="<?php echo esc_attr( $step ); ?>" value="<?php echo esc_attr( $component['min'] ); ?>"/>
									<?php esc_html_e( 'Max', 'wpc-composite-products' ); ?>
                                    <input name="wooco_components[<?php echo esc_attr( $key ); ?>][max]" class="wooco_component_max_val" type="number" min="0" step="<?php echo esc_attr( $step ); ?>" value="<?php echo esc_attr( $component['max'] ); ?>"/>
                                </div>
                            </div>
                            <div class="wooco_component_content_line wooco_show_if_custom_qty">
                                <div class="wooco_component_content_line_label">
                                ...
                                <div class="wooco_component_content_line_value">
									<?php esc_html_e( 'Min', 'wpc-composite-products' ); ?>
                                    <input name="wooco_components[<?php echo esc_attr( $key ); ?>][m_min]" class="wooco_component_m_min_val" type="number" min="0" step="<?php echo esc_attr( $step ); ?>" value="<?php echo esc_attr( $component['m_min'] ); ?>"/>
									<?php esc_html_e( 'Max', 'wpc-composite-products' ); ?>
                                    <input name="wooco_components[<?php echo esc_attr( $key ); ?>][m_max]" class="wooco_component_m_max_val" type="number" min="0" step="<?php echo esc_attr( $step ); ?>" value="<?php echo esc_attr( $component['m_max'] ); ?>"/>
                                    <span class="woocommerce-help-tip" data-tip="<?php esc_html_e( 'For multiple selection only.', 'wpc-composite-products' ); ?>"></span>
                                </div>
                            </div>
                            <div class="wooco_component_content_line">
                                <div class="wooco_component_content_line_label">
                                ...
                                <div class="wooco_component_content_line_value">
                                    <select name="wooco_components[<?php echo esc_attr( $key ); ?>][multiple]" class="wooco_component_multiple_val">
                            ...
                            <div class="wooco_component_content_line">
                                ...
                                <div class="wooco_component_content_line_value">
                                    <select name="wooco_components[<?php echo esc_attr( $key ); ?>][selector]" class="wooco_component_selector_val">
                                    ...
                                    <span class="woocommerce-help-tip" data-tip="<?php esc_html_e( 'Specify selector interface for this component. If not, the default selector interface will be used.', 'wpc-composite-products' ); ?>"></span>
                                </div>
                            </div>
                        </div>
                    </div>
		...
		function ajax_export_components() {
			...
			echo '<textarea style="width: 100%; height: 200px">' . ( ! empty( $components ) ? serialize( $components ) : '' ) . '</textarea>';
		...
		function ajax_load_gallery() {
			check_ajax_referer( 'wooco_nonce', 'nonce' );
			...
			foreach ( $_POST['ids'] as $id ) {
				$id_arr = explode( '/', $id );
				$_id    = isset( $id_arr[0] ) ? absint( $id_arr[0] ) : 0;
		...
		function ajax_search_product() {
			...
			foreach ( $ids as $id ) {
				...
				if ( apply_filters( 'wooco_use_sku', false ) ) {
					$products[] = [
		...
		function admin_menu_content() {
            ...
            <div class="wpclever_settings_page wrap">
                <h1 class="wpclever_settings_page_title"><?php echo esc_html__( 'WPC Composite Products', 'wpc-composite-products' ) . ' ' . WOOCO_VERSION . ' ' . ( defined( 'WOOCO_PREMIUM' ) ? '<span class="premium" style="display: none">' . esc_html__( 'Premium', 'wpc-composite-products' ) . '</span>' : '' ); ?></h1>
                <div class="wpclever_settings_page_desc about-text">
                    <p>
                        ...
                        <br/>
                        <a href="<?php echo esc_url( WOOCO_REVIEWS ); ?>" target="_blank"><?php esc_html_e( 'Reviews', 'wpc-composite-products' ); ?></a> |
                        <a href="<?php echo esc_url( WOOCO_CHANGELOG ); ?>" target="_blank"><?php esc_html_e( 'Changelog', 'wpc-composite-products' ); ?></a> |
                        <a href="<?php echo esc_url( WOOCO_DISCUSSION ); ?>" target="_blank"><?php esc_html_e( 'Discussion', 'wpc-composite-products' ); ?></a>
                    </p>
                </div>
                ...
                <div class="wpclever_settings_page_nav">
                    <h2 class="nav-tab-wrapper">
                        <a href="<?php echo admin_url( 'admin.php?page=wpclever-wooco&tab=how' ); ?>" class="<?php echo $active_tab === 'how' ? 'nav-tab nav-tab-active' : 'nav-tab'; ?>">
							<?php esc_html_e( 'How to use?', 'wpc-composite-products' ); ?>
                        </a>
                        <a href="<?php echo admin_url( 'admin.php?page=wpclever-wooco&tab=settings' ); ?>" class="<?php echo $active_tab === 'settings' ? 'nav-tab nav-tab-active' : 'nav-tab'; ?>">
							<?php esc_html_e( 'Settings', 'wpc-composite-products' ); ?>
                        </a>
                        <a href="<?php echo admin_url( 'admin.php?page=wpclever-wooco&tab=localization' ); ?>" class="<?php echo $active_tab === 'localization' ? 'nav-tab nav-tab-active' : 'nav-tab'; ?>">
                        ...
                        <a href="<?php echo admin_url( 'admin.php?page=wpclever-wooco&tab=premium' ); ?>" class="<?php echo $active_tab === 'premium' ? 'nav-tab nav-tab-active' : 'nav-tab'; ?>" style="color: #c9356e">
                        ...
                        <form method="post" action="options.php">
                            <table class="form-table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="wooco_settings[price_format]">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="wooco_settings[product_price]">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="wooco_settings[selector]">
                                        ...
                                        <span class="description">Read more about <a href="https://designwithpc.com/Plugins/ddSlick" target="_blank">ddSlick</a>, <a href="https://select2.org/" target="_blank">Select2</a> and <a href="https://www.w3schools.com/tags/tag_select.asp" target="_blank">HTML select tag</a></span>
                                    </td>
                                </tr>
                                <tr>
                                    <th><?php esc_html_e( 'Exclude hidden', 'wpc-composite-products' ); ?></th>
                                    <td>
                                        <select name="wooco_settings[exclude_hidden]">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="wooco_settings[exclude_unpurchasable]">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="wooco_settings[show_alert]">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="wooco_settings[show_qty]">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="wooco_settings[show_image]">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="wooco_settings[show_price]">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="wooco_settings[show_availability]">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="wooco_settings[show_short_description]">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="wooco_settings[checkbox]">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="wooco_settings[checked]">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="wooco_settings[option_none_image]" class="wooco_option_none_image">
                                        ...
                                        <div class="wooco_option_none_image_custom" style="display: none">
                                            ...
                                            <span class="wooco_option_none_image_preview" id="wooco_option_none_image_preview">
                                                        <?php if ( $option_none_image_id ) {
	                                                        echo '<img src="' . wp_get_attachment_url( $option_none_image_id ) . '"/>';
                                                        } ?>
                                                    </span>
                                            <input id="wooco_option_none_image_upload" type="button" class="button" value="<?php esc_attr_e( 'Upload image', 'wpc-composite-products' ); ?>"/>
                                            <input type="hidden" name="wooco_settings[option_none_image_id]" id="wooco_option_none_image_id" value="<?php echo $option_none_image_id; ?>"/>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <select name="wooco_settings[option_none_required]">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="wooco_settings[change_image]">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="wooco_settings[change_price]" class="wooco_change_price">
                                        ...
                                        <input type="text" name="wooco_settings[change_price_custom]" value="<?php echo esc_attr( $change_price_custom ); ?>" placeholder=".summary > .price" class="wooco_change_price_custom"/>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="wooco_settings[product_link]">
                                        ...
                                        <span class="description"><?php esc_html_e( 'Add a link to the target individual product below this selection.', 'wpc-composite-products' ); ?> If you choose "Open quick view popup", please install <a href="<?php echo esc_url( admin_url( 'plugin-install.php?tab=plugin-information&plugin=woo-smart-quick-view&TB_iframe=true&width=800&height=550' ) ); ?>" class="thickbox" title="WPC Smart Quick View">WPC Smart Quick View</a> to make it work.</span>
                                    </td>
                                </tr>
                                <tr class="heading">
                                    <th colspan="2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="wooco_settings[coupon_restrictions]">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="wooco_settings[cart_contents_count]">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="wooco_settings[hide_composite_name]">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="wooco_settings[hide_component_name]">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="wooco_settings[hide_component_mini_cart]">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="wooco_settings[hide_component]">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="wooco_settings[hide_component_order]">
                                ...
                                <tr class="heading">
                                    <th colspan="2"><?php esc_html_e( 'Suggestion', 'wpc-composite-products' ); ?></th>
                                </tr>
                                <tr>
                                    <td colspan="2">
                        ...
                        <form method="post" action="options.php">
                            <table class="form-table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="regular-text" name="wooco_localization[option_none]" value="<?php echo esc_attr( self::localization( 'option_none' ) ); ?>" placeholder="<?php esc_attr_e( 'No, thanks. I don\'t need this', 'wpc-composite-products' ); ?>"/>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="regular-text" name="wooco_localization[option_none_required]" value="<?php echo esc_attr( self::localization( 'option_none_required' ) ); ?>" placeholder="<?php esc_attr_e( 'Please make your choice here', 'wpc-composite-products' ); ?>"/>
                                        <span class="description"><?php esc_html_e( 'Text to display for showing a "Don\'t choose any product" option.', 'wpc-composite-products' ); ?></span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="wooco_localization[total]" class="regular-text" value="<?php echo esc_attr( self::localization( 'total' ) ); ?>" placeholder="<?php esc_attr_e( 'Total price:', 'wpc-composite-products' ); ?>"/>
                                    </td>
                                </tr>
                                <tr>
                                    <th><?php esc_html_e( 'Saved text', 'wpc-composite-products' ); ?></th>
                                    <td>
                                        <input type="text" name="wooco_localization[saved]" class="regular-text" value="<?php echo esc_attr( self::localization( 'saved' ) ); ?>" placeholder="<?php esc_attr_e( '(saved [d])', 'wpc-composite-products' ); ?>"/>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="regular-text" name="wooco_localization[qty_label]" value="<?php echo esc_attr( self::localization( 'qty_label' ) ); ?>" placeholder="<?php esc_attr_e( 'Qty:', 'wpc-composite-products' ); ?>"/>
                                    </td>
                                </tr>
                                <tr class="heading">
                                    <th colspan="2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div style="margin-bottom: 5px">
                                            <input type="text" class="regular-text" name="wooco_localization[button_select]" value="<?php echo esc_attr( self::localization( 'button_select' ) ); ?>" placeholder="<?php esc_attr_e( 'Select options', 'wpc-composite-products' ); ?>"/>
                                            <span class="description"><?php esc_html_e( 'For purchasable composites.', 'wpc-composite-products' ); ?></span>
                                        </div>
                                        <div>
                                            <input type="text" class="regular-text" name="wooco_localization[button_read]" value="<?php echo esc_attr( self::localization( 'button_read' ) ); ?>" placeholder="<?php esc_attr_e( 'Read more', 'wpc-composite-products' ); ?>"/>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="regular-text" name="wooco_localization[button_single]" value="<?php echo esc_attr( self::localization( 'button_single' ) ); ?>" placeholder="<?php esc_attr_e( 'Add to cart', 'wpc-composite-products' ); ?>"/>
                                    </td>
                                </tr>
                                <tr class="heading">
                                    <th colspan="2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="regular-text" name="wooco_localization[cart_components]" value="<?php echo esc_attr( self::localization( 'cart_components' ) ); ?>" placeholder="<?php esc_attr_e( 'Components', 'wpc-composite-products' ); ?>"/>
                                    </td>
                                </tr>
                                <tr>
                                    <th><?php esc_html_e( 'Components: %s', 'wpc-composite-products' ); ?></th>
                                    <td>
                                        <input type="text" class="regular-text" name="wooco_localization[cart_components_s]" value="<?php echo esc_attr( self::localization( 'cart_components_s' ) ); ?>" placeholder="<?php esc_attr_e( 'Components: %s', 'wpc-composite-products' ); ?>"/>
                                    </td>
                                </tr>
                                <tr>
                                    <th><?php esc_html_e( 'Composite: %s', 'wpc-composite-products' ); ?></th>
                                    <td>
                                        <input type="text" class="regular-text" name="wooco_localization[cart_composite_s]" value="<?php echo esc_attr( self::localization( 'cart_composite_s' ) ); ?>" placeholder="<?php esc_attr_e( 'Composite: %s', 'wpc-composite-products' ); ?>"/>
                                    </td>
                                </tr>
                                <tr class="heading">
                                    <th colspan="2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="large-text" name="wooco_localization[alert_selection]" value="<?php echo esc_attr( self::localization( 'alert_selection' ) ); ?>" placeholder="<?php esc_attr_e( 'Please choose a purchasable product for the component [name] before adding this composite to the cart.', 'wpc-composite-products' ); ?>"/>
                                    </td>
                                </tr>
                                <tr>
                                    <th><?php esc_html_e( 'Different selection', 'wpc-composite-products' ); ?></th>
                                    <td>
                                        <input type="text" class="large-text" name="wooco_localization[alert_same]" value="<?php echo esc_attr( self::localization( 'alert_same' ) ); ?>" placeholder="<?php esc_attr_e( 'Please select a different product for each component.', 'wpc-composite-products' ); ?>"/>
                                    </td>
                                </tr>
                                <tr>
                                    <th><?php esc_html_e( 'Whole component\'s quantity minimum required', 'wpc-composite-products' ); ?></th>
                                    <td>
                                        <input type="text" class="large-text" name="wooco_localization[alert_m_min]" value="<?php echo esc_attr( self::localization( 'alert_m_min' ) ); ?>" placeholder="<?php esc_attr_e( 'Please choose at least a total quantity of [min] products for the component [name].', 'wpc-composite-products' ); ?>"/>
                                    </td>
                                </tr>
                                <tr>
                                    <th><?php esc_html_e( 'Whole component\'s quantity maximum reached', 'wpc-composite-products' ); ?></th>
                                    <td>
                                        <input type="text" class="large-text" name="wooco_localization[alert_m_max]" value="<?php echo esc_attr( self::localization( 'alert_m_max' ) ); ?>" placeholder="<?php esc_attr_e( 'Sorry, you can only choose at max a total quantity of [max] products for the component [name].', 'wpc-composite-products' ); ?>"/>
                                    </td>
                                </tr>
                                <tr>
                                    <th><?php esc_html_e( 'Minimum required', 'wpc-composite-products' ); ?></th>
                                    <td>
                                        <input type="text" class="large-text" name="wooco_localization[alert_min]" value="<?php echo esc_attr( self::localization( 'alert_min' ) ); ?>" placeholder="<?php esc_attr_e( 'Please choose at least a total quantity of [min] products before adding this composite to the cart.', 'wpc-composite-products' ); ?>"/>
                                    </td>
                                </tr>
                                <tr>
                                    <th><?php esc_html_e( 'Maximum reached', 'wpc-composite-products' ); ?></th>
                                    <td>
                                        <input type="text" class="large-text" name="wooco_localization[alert_max]" value="<?php echo esc_attr( self::localization( 'alert_max' ) ); ?>" placeholder="<?php esc_attr_e( 'Sorry, you can only choose at max a total quantity of [max] products before adding this composite to the cart.', 'wpc-composite-products' ); ?>"/>
                                    </td>
                                </tr>
                                <tr>
                                    <th><?php esc_html_e( 'Total minimum required', 'wpc-composite-products' ); ?></th>
                                    <td>
                                        <input type="text" class="large-text" name="wooco_localization[alert_total_min]" value="<?php echo esc_attr( self::localization( 'alert_total_min' ) ); ?>" placeholder="<?php esc_attr_e( 'The total must meet the minimum amount of [min].', 'wpc-composite-products' ); ?>"/>
                                    </td>
                                </tr>
                                <tr>
                                    <th><?php esc_html_e( 'Total maximum required', 'wpc-composite-products' ); ?></th>
                                    <td>
                                        <input type="text" class="large-text" name="wooco_localization[alert_total_max]" value="<?php echo esc_attr( self::localization( 'alert_total_max' ) ); ?>" placeholder="<?php esc_attr_e( 'The total must meet the maximum amount of [max].', 'wpc-composite-products' ); ?>"/>
                                    </td>
                                </tr>
                                <tr class="submit">
                                    <th colspan="2">
                            ...
                            <tr class="heading">
                                ...
                                <td>
									...
									if ( isset( $_GET['act'] ) && ( $_GET['act'] === 'migrate' ) ) {
										...
										if ( ! empty( $posts ) ) {
                                            ...
                                            <script type="text/javascript">
                                              (function($) {
                                                $(function() {
                                                  setTimeout(function() {
                                                    window.location.href = '<?php echo admin_url( 'admin.php?page=wpclever-wooco&tab=tools&act=migrate&num=' . $num . '&paged=' . ( $paged + 1 ) ); ?>';
                                                  }, 1000);
                                                });
                                              })(jQuery);
                                            </script>
										...
										echo '<a class="button btn" href="' . admin_url( 'admin.php?page=wpclever-wooco&tab=tools&act=migrate' ) . '">' . esc_html__( 'Migrate', 'wpc-composite-products' ) . '</a>';
									}
									echo '</p>';
									?>
                                </td>
					...
					<?php } elseif ( $active_tab == 'premium' ) { ?>
                        <div class="wpclever_settings_page_content_text">
                            <p>
                                ...
                                <a href="https://wpclever.net/downloads/composite-products?utm_source=pro&utm_medium=wooco&utm_campaign=wporg" target="_blank">https://wpclever.net/downloads/composite-products</a>
                            </p>
		...
		function cart_item_subtotal( $subtotal, $cart_item = null ) {
			...
			if ( isset( $cart_item['wooco_parent_key'] ) ) {
				...
				if ( isset( WC()->cart->cart_contents[ $cart_parent_key ] ) && method_exists( WC()->cart->cart_contents[ $cart_parent_key ]['data'], 'get_pricing' ) && ( WC()->cart->cart_contents[ $cart_parent_key ]['data']->get_pricing() === 'only' ) ) {
					...
					return wc_price( wc_get_price_to_display( $item_product, [ 'qty' => $cart_item['quantity'] ] ) );
				}
			}
					...
					foreach ( $items as $item ) {
						...
						if ( $item_product->is_type( 'variation' ) ) {
							...
							foreach ( $attributes as $attribute ) {
								if ( empty( $attribute ) ) {
									wc_add_notice( sprintf( esc_html__( '"%s" is un-purchasable.', 'wpc-composite-products' ), esc_html( $item_product->get_name() ) ), 'error' );
									wc_add_notice( esc_html__( 'You cannot add this composite products to the cart.', 'wpc-composite-products' ), 'error' );
						...
						if ( $item_product->is_sold_individually() && apply_filters( 'wooco_sold_individually_found_in_cart', true ) && self::check_in_cart( $item['id'] ) ) {
							wc_add_notice( sprintf( esc_html__( 'You cannot add another "%s" to your cart.', 'wpc-composite-products' ), esc_html( $item_product->get_name() ) ), 'error' );
							wc_add_notice( esc_html__( 'You cannot add this composite products to the cart.', 'wpc-composite-products' ), 'error' );
						...
						if ( $item_product->managing_stock() ) {
							...
							if ( ! $item_product->has_enough_stock( $qty_in_cart + $qty_to_check * $qty ) ) {
								wc_add_notice( sprintf( esc_html__( '"%s" has not enough stock.', 'wpc-composite-products' ), esc_html( $item_product->get_name() ) ), 'error' );
								wc_add_notice( esc_html__( 'You cannot add this composite products to the cart.', 'wpc-composite-products' ), 'error' );
						...
						if ( post_password_required( $item['id'] ) ) {
							wc_add_notice( sprintf( esc_html__( '"%s" is protected and cannot be purchased.', 'wpc-composite-products' ), esc_html( $item_product->get_name() ) ), 'error' );
							wc_add_notice( esc_html__( 'You cannot add this composite products to the cart.', 'wpc-composite-products' ), 'error' );
				...
				foreach ( $items as $item ) {
					...
					if ( isset( $components[ $item_key ] ) && ( $item_product = wc_get_product( $item['id'] ) ) && ( 'trash' !== $item_product->get_status() ) && ( $item_id > 0 ) && ( $item_qty > 0 ) ) {
						...
						$item_data = [
							'wooco_pos'        => $count,
							'wooco_qty'        => $item_qty,
							'wooco_price'      => self::format_price( isset( $components[ $item_key ]['price'] ) ? $components[ $item_key ]['price'] : '100%' ),
							'wooco_component'  => isset( $components[ $item_key ]['name'] ) ? $components[ $item_key ]['name'] : '',
			...
			if ( self::get_setting( 'hide_component', 'no' ) === 'yes_list' ) {
				...
				if ( $items = self::get_items( $cart_item['wooco_ids'] ) ) {
					foreach ( $items as $item ) {
						if ( ( self::get_setting( 'hide_component_name', 'yes' ) === 'no' ) && ! empty( $item['component'] ) ) {
							$items_str[] = apply_filters( 'wooco_order_component_product_name', '<li>' . $item['component'] . ': ' . $item['qty'] . ' × ' . get_the_title( $item['id'] ) . '</li>', $item, $cart_item );
						} else {
							$items_str[] = apply_filters( 'wooco_order_component_product_name', '<li>' . $item['qty'] . ' × ' . get_the_title( $item['id'] ) . '</li>', $item, $cart_item );
						}
					}
				}
				...
				if ( ! empty( $items_str ) ) {
					$item_data[] = [
						...
						'display' => apply_filters( 'wooco_order_component_product_names', '<ul>' . implode( '', $items_str ) . '</ul>', $items ),
					];
				}
			} else {
				$items_str = [];
				...
				if ( ! empty( $items_str ) ) {
					$item_data[] = [
						'key'     => self::localization( 'cart_components', esc_html__( 'Components', 'wpc-composite-products' ) ),
						'value'   => esc_html( $cart_item['wooco_ids'] ),
						'display' => apply_filters( 'wooco_order_component_product_names', implode( '; ', $items_str ), $items ),
					];
				}
			}
		...
		function order_item_meta_start( $order_item_id, $order_item ) {
			if ( $ids = $order_item->get_meta( 'wooco_ids' ) ) {
				if ( $items = self::get_items( $ids ) ) {
					...
					echo apply_filters( 'wooco_before_order_itemmeta_composite', '<div class="wooco-itemmeta-composite">' . sprintf( self::localization( 'cart_components_s', esc_html__( 'Components: %s', 'wpc-composite-products' ) ), $items_str ) . '</div>', $order_item_id, $order_item );
				}
			}

			if ( $parent_id = $order_item->get_meta( 'wooco_parent_id' ) ) {
				if ( ( $component = $order_item->get_meta( 'wooco_component' ) ) && ! empty( $component ) ) {
					echo apply_filters( 'wooco_before_order_itemmeta_component', '<div class="wooco-itemmeta-component">' . sprintf( self::localization( 'cart_composite_s', esc_html__( 'Composite: %s', 'wpc-composite-products' ) ), get_the_title( $parent_id ) . apply_filters( 'wooco_name_separator', ' &rarr; ' ) . $component ) . '</div>', $order_item_id, $order_item );
				} else {
					echo apply_filters( 'wooco_before_order_itemmeta_component', '<div class="wooco-itemmeta-component">' . sprintf( self::localization( 'cart_composite_s', esc_html__( 'Composite: %s', 'wpc-composite-products' ) ), get_the_title( $parent_id ) ) . '</div>', $order_item_id, $order_item );
				}
			}
		}
		...
		function before_order_itemmeta( $order_item_id, $order_item ) {
			if ( $ids = $order_item->get_meta( 'wooco_ids' ) ) {
				if ( $items = self::get_items( $ids ) ) {
					...
					foreach ( $items as $item ) {
						if ( ( self::get_setting( 'hide_component_name', 'yes' ) === 'no' ) && ! empty( $item['component'] ) ) {
							$items_str[] = apply_filters( 'wooco_admin_order_component_product_name', '<li>' . $item['component'] . ': ' . $item['qty'] . ' × ' . get_the_title( $item['id'] ) . '</li>', $item );
						} else {
							$items_str[] = apply_filters( 'wooco_admin_order_component_product_name', '<li>' . $item['qty'] . ' × ' . get_the_title( $item['id'] ) . '</li>', $item );
						}
					}

					$items_str = apply_filters( 'wooco_order_component_product_names', '<ul>' . implode( '', $items_str ) . '</ul>', $items );

					echo apply_filters( 'wooco_before_admin_order_itemmeta_composite', '<div class="wooco-itemmeta-composite">' . sprintf( self::localization( 'cart_components_s', esc_html__( 'Components: %s', 'wpc-composite-products' ) ), $items_str ) . '</div>', $order_item_id, $order_item );
				}
			}

			if ( $parent_id = $order_item->get_meta( 'wooco_parent_id' ) ) {
				if ( ( $component = $order_item->get_meta( 'wooco_component' ) ) && ! empty( $component ) ) {
					echo apply_filters( 'wooco_before_admin_order_itemmeta_component', '<div class="wooco-itemmeta-component">' . sprintf( self::localization( 'cart_composite_s', esc_html__( 'Composite: %s', 'wpc-composite-products' ) ), get_the_title( $parent_id ) . apply_filters( 'wooco_name_separator', ' &rarr; ' ) . $component ) . '</div>', $order_item_id, $order_item );
				} else {
					echo apply_filters( 'wooco_before_admin_order_itemmeta_component', '<div class="wooco-itemmeta-component">' . sprintf( self::localization( 'cart_composite_s', esc_html__( 'Composite: %s', 'wpc-composite-products' ) ), get_the_title( $parent_id ) ) . '</div>', $order_item_id, $order_item );
				}
			}
		}
                ...
                <table>
                    <tr class="wooco_tr_space">
                        ...
                        <td>
                            ...
                            <span class="woocommerce-help-tip" data-tip="<?php esc_attr_e( '"Base price" is the price set in the General tab. When "Only base price" is chosen, the total price won\'t change despite the price changes in variable components.', 'wpc-composite-products' ); ?>"></span>
                    ...
                    <tr class="wooco_tr_space">
                        ...
                        <td style="vertical-align: middle; line-height: 30px;">
                            <input id="wooco_discount_percent" name="wooco_discount_percent" type="number" min="0.0001" step="0.0001" max="99.9999" value="<?php echo esc_attr( get_post_meta( $product_id, 'wooco_discount_percent', true ) ?: '' ); ?>" style="width: 80px"/>%.
                            <span class="woocommerce-help-tip" data-tip="<?php esc_attr_e( 'The universal percentage discount will be applied equally on each component\'s price, not on the total.', 'wpc-composite-products' ); ?>"></span>
                        </td>
                    </tr>
                    <tr class="wooco_tr_space">
						<?php
                        ...
                        <td style="vertical-align: middle; line-height: 30px;">
                            Min
                            <input name="wooco_qty_min" type="number" style="width: 80px" min="0" step="<?php echo esc_attr( $step ); ?>" value="<?php echo esc_attr( $min ); ?>"/> Max
                            <input name="wooco_qty_max" type="number" min="0" style="width: 80px" step="<?php echo esc_attr( $step ); ?>" value="<?php echo esc_attr( $max ); ?>"/>
                        </td>
                    </tr>
                    <tr class="wooco_tr_space">
                        <th><?php esc_html_e( 'Total limits', 'wpc-composite-products' ); ?></th>
                        <td>
                            <input id="wooco_total_limits" name="wooco_total_limits" type="checkbox" <?php echo( get_post_meta( $product_id, 'wooco_total_limits', true ) === 'on' ? 'checked' : '' ); ?>/>
                            ...
                            <span class="wooco_show_if_total_limits">
                                        Min <input id="wooco_total_limits_min" name="wooco_total_limits_min" type="number" min="0" style="width: 80px" value="<?php echo esc_attr( get_post_meta( $product_id, 'wooco_total_limits_min', true ) ); ?>"/>
                                        Max <input id="wooco_total_limits_max" name="wooco_total_limits_max" type="number" min="0" style="width: 80px" value="<?php echo esc_attr( get_post_meta( $product_id, 'wooco_total_limits_max', true ) ); ?>"/> <?php echo get_woocommerce_currency_symbol(); ?>
                                    </span>
                        </td>
                    </tr>
                    <tr class="wooco_tr_space">
                        ...
                        <td>
                            ...
                            <span class="woocommerce-help-tip" data-tip="<?php esc_attr_e( 'Allow/Do not allow the buyer to choose the same products in the components.', 'wpc-composite-products' ); ?>"></span>
                        </td>
                    </tr>
                    <tr class="wooco_tr_space">
                    ...
                    <tr class="wooco_tr_space">
                        ...
                        <td>
                            <input type="text" name="wooco_custom_price" value="<?php echo stripslashes( get_post_meta( $product_id, 'wooco_custom_price', true ) ); ?>"/> E.g:
                    ...
                    <tr class="wooco_tr_space">
                        ...
                        <td>
                            <div class="w100">
                                <textarea name="wooco_before_text"><?php echo stripslashes( get_post_meta( $product_id, 'wooco_before_text', true ) ); ?></textarea>
                            </div>
                        </td>
                    </tr>
                    <tr class="wooco_tr_space">
                        ...
                        <td>
                            <div class="w100">
                                <textarea name="wooco_after_text"><?php echo stripslashes( get_post_meta( $product_id, 'wooco_after_text', true ) ); ?></textarea>
                            </div>
                        </td>
                    </tr>
		...
		function show_items( $product = null ) {
			...
			$df_products = isset( $_GET['df'] ) ? explode( ',', sanitize_text_field( $_GET['df'] ) ) : [];
			$product_id  = $product->get_id();
			$order       = 1;
			...
			if ( $components = $product->get_components() ) {
				...
				?>
                <div class="<?php echo esc_attr( apply_filters( 'wooco_components_class', 'wooco_components wooco-components', $product ) ); ?>" data-percent="<?php echo esc_attr( $product->get_discount() ); ?>" data-min="<?php echo esc_attr( get_post_meta( $product_id, 'wooco_qty_min', true ) ); ?>" data-max="<?php echo esc_attr( get_post_meta( $product_id, 'wooco_qty_max', true ) ); ?>" data-price="<?php echo esc_attr( wc_get_price_to_display( $product ) ); ?>" data-regular-price="<?php echo esc_attr( wc_get_price_to_display( $product, [ 'price' => $product->get_regular_price() ] ) ); ?>" data-pricing="<?php echo esc_attr( $product->get_pricing() ); ?>" data-same="<?php echo esc_attr( get_post_meta( $product_id, 'wooco_same_products', true ) === 'do_not_allow' ? 'no' : 'yes' ); ?>" data-checkbox="<?php echo esc_attr( self::get_setting( 'checkbox', 'no' ) ); ?>" data-total-min="<?php echo esc_attr( $total_limit && $total_limit_min ? $total_limit_min : 0 ); ?>" data-total-max="<?php echo esc_attr( $total_limit && $total_limit_max ? $total_limit_max : '-1' ); ?>">
					<?php
					foreach ( $components as $key => $component ) {
						$component_type = $component['type'];

						if ( $component_type === 'products' ) {
							$component_val = isset( $component['products'] ) ? $component['products'] : [];
						} else {
							$component_val = isset( $component['other'] ) ? $component['other'] : [];
						}

						$component_default = isset( $component['default'] ) ? $component['default'] : 0;
						...
						$component_exclude    = isset( $component['exclude'] ) ? $component['exclude'] : [];
						...
						if ( ! $component_products ) {
							if ( $component_required ) {
								...
								?>
                                <div class="wooco_component_product wooco_component_product_none" data-key="<?php echo esc_attr( $key ); ?>" data-name="<?php echo esc_attr( $component['name'] ); ?>" data-id="0" data-qty="<?php echo esc_attr( $component_qty ); ?>" data-m-min="<?php echo esc_attr( ! empty( $component['m_min'] ) ? (float) $component['m_min'] : '0' ); ?>" data-m-max="<?php echo esc_attr( ! empty( $component['m_max'] ) ? (float) $component['m_max'] : '10000' ); ?>" data-price="0" data-regular-price="0" data-new-price="0" data-required="yes" data-custom-qty="<?php echo esc_attr( $component_custom_qty ? 'yes' : 'no' ); ?>" data-multiple="<?php echo esc_attr( $component_multiple ? 'yes' : 'no' ); ?>"></div>
								<?php
							}
						} elseif ( ( count( $component_products ) === 1 ) && ( $component_required || $checkbox ) ) {
							...
							if ( $only_product ) {
								...
								$only_product_image = $only_product->get_image( self::$image_size );

								if ( $product_link !== 'no' ) {
									if ( $only_product->is_visible() || apply_filters( 'wooco_hidden_product_link', false ) ) {
										$quickview_id       = is_a( $only_product, 'WC_Product_Variation' ) && ( apply_filters( 'wooco_quickview_variation', 'default' ) === 'parent' ) ? $only_product->get_parent_id() : $only['id'];
										$only_product_name  = '<a ' . ( $product_link === 'yes_popup' ? 'class="woosq-link" data-id="' . esc_attr( $quickview_id ) . '" data-context="wooco"' : '' ) . ' href="' . $only_product->get_permalink() . '" ' . ( $product_link === 'yes_blank' ? 'target="_blank"' : '' ) . '>' . $only['name'] . '</a>';
										$only_product_image = '<a ' . ( $product_link === 'yes_popup' ? 'class="woosq-link" data-id="' . esc_attr( $quickview_id ) . '" data-context="wooco"' : '' ) . ' href="' . $only_product->get_permalink() . '" ' . ( $product_link === 'yes_blank' ? 'target="_blank"' : '' ) . '>' . $only_product->get_image( self::$image_size ) . '</a>';
									}
								}
								?>
                                <div class="wooco_component_product wooco_component_product_only" data-key="<?php echo esc_attr( $key ); ?>" data-name="<?php echo esc_attr( $component['name'] ); ?>" data-id="<?php echo esc_attr( $only['purchasable'] === 'yes' ? $only['id'] : 0 ); ?>" data-qty="<?php echo esc_attr( $component['qty'] ); ?>" data-m-min="<?php echo esc_attr( ! empty( $component['m_min'] ) ? (float) $component['m_min'] : '0' ); ?>" data-m-max="<?php echo esc_attr( ! empty( $component['m_max'] ) ? (float) $component['m_max'] : '10000' ); ?>" data-price="<?php echo esc_attr( $only['price'] ); ?>" data-regular-price="<?php echo esc_attr( wc_get_price_to_display( $only_product, [ 'price' => $only_product->get_regular_price() ] ) ); ?>" data-new-price="<?php echo esc_attr( $component_price ); ?>" data-required="<?php echo esc_attr( $component_required ? 'yes' : 'no' ); ?>" data-custom-qty="<?php echo esc_attr( $component_custom_qty ? 'yes' : 'no' ); ?>" data-multiple="<?php echo esc_attr( $component_multiple ? 'yes' : 'no' ); ?>">

									<?php if ( $checkbox && $component_dropdown ) { ?>
                                        <div class="wooco_component_product_checkbox">
                                            <input class="wooco-checkbox" type="checkbox" <?php echo( apply_filters( 'wooco_component_checkbox_checked', $checked || $component_required, $component ) ? 'checked="checked"' : '' ); ?>
                                    ...
                                    <div class="wooco_component_product_info">
                                        <div class="wooco_component_product_name">
											...
											do_action( 'wooco_after_component_product_name', $only_product, $component, $product );
											?>
                                        </div>
									...
									<?php if ( $component_custom_qty ) {
										...
										$qty_input .= '<input class="wooco_component_product_qty_input input-text text qty" type="number" min="' . esc_attr( $min ) . '" max="' . esc_attr( $max ) . '" step="' . esc_attr( $step ) . '" value="' . esc_attr( $qty ) . '"/>';
										$qty_input .= '<span class="wooco_component_product_qty_btn wooco_component_product_qty_plus wooco-plus">+</span>';
										$qty_input .= '</span>';
										$qty_input .= '</div>';

										echo apply_filters( 'wooco_qty_input', $qty_input, $qty, $step, $min, $max );
									} ?>
                                </div>
								<?php
							}
							...
							?>
                            <div class="wooco_component_product" data-key="<?php echo esc_attr( $key ); ?>" data-id="-1" data-qty="<?php echo esc_attr( $component['qty'] ); ?>" data-m-min="<?php echo esc_attr( ! empty( $component['m_min'] ) ? (float) $component['m_min'] : '0' ); ?>" data-m-max="<?php echo esc_attr( ! empty( $component['m_max'] ) ? (float) $component['m_max'] : '10000' ); ?>" data-price="0" data-regular-price="0" data-price-html="" data-name="<?php echo esc_attr( $component['name'] ); ?>" data-new-price="<?php echo esc_attr( $component_price ); ?>" data-required="<?php echo esc_attr( $component_required ? 'yes' : 'no' ); ?>" data-custom-qty="<?php echo esc_attr( $component_custom_qty ? 'yes' : 'no' ); ?>" data-multiple="<?php echo esc_attr( $component_multiple ? 'yes' : 'no' ); ?>">
                                ...
                                <div class="wooco_component_product_selection">
									<?php if ( ! $component_dropdown ) {
										...
										if ( $component_selector === 'list' ) {
											...
											foreach ( $component_products as $component_product ) {
												if ( $component_product_obj = wc_get_product( $component_product['id'] ) ) {
													...
													echo '<div class="wooco_component_product_selection_list_item wooco_component_product_selection_item ' . ( $item_selected ? 'wooco_item_selected' : '' ) . '" ' . self::data_attributes( $component_product ) . '>';
													echo '<div class="wooco_component_product_selection_list_item_choose"><span></span></div>';
													echo '<div class="wooco_component_product_selection_list_item_image">' . $component_product_obj->get_image() . '</div>';
													...
													if ( $component_custom_qty ) {
														...
														$qty_input = '<div class="wooco_component_product_selection_list_item_qty wooco_component_product_selection_item_qty wooco-qty">';
														$qty_input .= '<span class="wooco-qty-label">' . self::localization( 'qty_label', esc_html__( 'Qty:', 'wpc-composite-products' ) ) . '</span>';
														$qty_input .= '<span class="wooco-qty-input">';
														$qty_input .= '<span class="wooco_component_product_qty_btn wooco_component_product_qty_minus wooco-minus">-</span>';
														...
														], $component_product_obj );
														$qty_input .= ob_get_clean();
													...
													if ( $product_link !== 'no' ) {
														if ( $component_product_obj->is_visible() || apply_filters( 'wooco_hidden_product_link', false ) ) {
															...
															echo '<div class="wooco_component_product_selection_list_item_link"><a ' . ( $product_link === 'yes_popup' ? 'class="woosq-link" data-id="' . esc_attr( $quickview_id ) . '" data-context="wooco"' : 'class="wooco_component_product_selection_list_item_link"' ) . ' href="' . $component_product_obj->get_permalink() . '" ' . ( $product_link === 'yes_blank' ? 'target="_blank"' : '' ) . '>' . $component_product_obj->get_name() . '</a></div>';
														}
													}
											...
											foreach ( $component_products as $component_product ) {
												if ( $component_product_obj = wc_get_product( $component_product['id'] ) ) {
													$item_selected = apply_filters( 'wooco_component_product_selected', isset( $component['default'] ) && ( $component['default'] == $component_product['id'] ), $component_product, $component );
													echo '<div class="wooco_component_product_selection_grid_item wooco_component_product_selection_item ' . ( $item_selected ? 'wooco_item_selected' : '' ) . '" ' . self::data_attributes( $component_product ) . '>';
													echo '<div class="wooco_component_product_selection_grid_item_image">' . $component_product_obj->get_image() . '</div>';
													...
													if ( $component_custom_qty ) {
														...
														$qty_input = '<div class="wooco_component_product_selection_grid_item_qty wooco_component_product_selection_item_qty wooco-qty">';
														$qty_input .= '<span class="wooco-qty-label">' . self::localization( 'qty_label', esc_html__( 'Qty:', 'wpc-composite-products' ) ) . '</span>';
														$qty_input .= '<span class="wooco-qty-input">';
														$qty_input .= '<span class="wooco_component_product_qty_btn wooco_component_product_qty_minus wooco-minus">-</span>';
													...
													if ( $product_link !== 'no' ) {
														if ( $component_product_obj->is_visible() || apply_filters( 'wooco_hidden_product_link', false ) ) {
															$quickview_id = is_a( $component_product_obj, 'WC_Product_Variation' ) && ( apply_filters( 'wooco_quickview_variation', 'default' ) === 'parent' ) ? $component_product_obj->get_parent_id() : $component_product['id'];
															echo '<a ' . ( $product_link === 'yes_popup' ? 'class="wooco_component_product_selection_grid_item_link woosq-link" data-id="' . esc_attr( $quickview_id ) . '" data-context="wooco"' : 'class="wooco_component_product_selection_grid_item_link"' ) . ' href="' . $component_product_obj->get_permalink() . '" ' . ( $product_link === 'yes_blank' ? 'target="_blank"' : '' ) . '>' . $component_product_obj->get_name() . '</a>';
														}
													}
                                        ...
                                        <select class="wooco_component_product_select" id="<?php echo esc_attr( 'wooco_component_product_select_' . $order ); ?>">
											<?php
											if ( ( self::get_setting( 'checkbox', 'no' ) === 'no' ) && ( ! $component_required || ( self::get_setting( 'option_none_required', 'no' ) === 'yes' ) ) ) {
					...
					if ( $_product->is_type( 'variable' ) ) {
						...
						if ( ! empty( $children ) ) {
							foreach ( $children as $child ) {
								...
								if ( apply_filters( 'wooco_check_variation_attribute', true ) && ( substr( $type, 0, 3 ) === 'pa_' ) ) {
			...
			if ( ! empty( $ids ) ) {
				...
				if ( is_array( $items ) && count( $items ) > 0 ) {
					foreach ( $items as $item ) {
						...
						$arr[]    = [
							'id'  => isset( $item_arr[0] ) ? absint( $item_arr[0] ) : 0,
							'qty' => isset( $item_arr[1] ) ? (float) $item_arr[1] : 1,
							'key' => isset( $item_arr[2] ) ? sanitize_key( $item_arr[2] ) : ''
						];
					}
				}
			}
